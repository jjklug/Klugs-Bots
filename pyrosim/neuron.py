...
class NEURON: 
    ...
    #Methods I added!! below all the way to the private methods line
    ...
    def Allow_Presynaptic_Neuron_To_Influence_Me(self, synapse_weight, presynaptic_neuron):
        result = synapse_weight*presynaptic_neuron
